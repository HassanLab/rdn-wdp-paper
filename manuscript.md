...
+-----------+-----------+-----------+-----------+-----------+-----------+
| **Gene**  | **Express | **Follows | **Chip    | **GO term | **Referen |
|           | ion       | ato?**    | peak?**   | (selectio | ce**      |
|           | group**   |           |           | n)**      |           |
+===========+===========+===========+===========+===========+===========+
| *ato*     | MF        | Strong    | Strong    | R8 cell   | Jarman et |
|           |           |           |           | fate      | al., 1994 |
|           |           |           |           | commitmen |           |
|           |           |           |           | t         |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| *Brd*     | MF        | Strong    | No        | negative  | Lai et    |
|           |           |           |           | regulatio | al., 2000 |
|           |           |           |           | n         |           |
|           |           |           |           | of Notch  |           |
|           |           |           |           | signaling |           |
|           |           |           |           | pathway   |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| *βTub60D* | MF        | No        | No        | axonogene | Hoyle et  |
|           |           |           |           | sis       | al., 2000 |
+-----------+-----------+-----------+-----------+-----------+-----------+
...
| *CG9801*  | MF        | Strong    | No        |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *E(spl) | MF        | Strong    | No        | Notch     | Bailey    |
| mδ-HLH*   |           |           |           | signaling | and       |
|           |           |           |           | pathway   | Posakony  |
|           |           |           |           |           | (1995)    |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *Fas2*  | MF        | Strong    | No        | negative  | Mao and   |
|           |           |           |           | regulatio | Freeman,  |
|           |           |           |           | n\        | 2009      |
|           |           |           |           | of EGFR   |           |
|           |           |           |           | signaling |           |
|           |           |           |           | pathway   |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *nvy*   | MF        | Strong    | Strong    | negative  | Wildonger |
|           |           |           |           | regulatio | and Mann, |
|           |           |           |           | n\        | 2005      |
|           |           |           |           | of Notch  |           |
|           |           |           |           | signaling |           |
|           |           |           |           | pathway   |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *sca*   | MF        | Strong    | Medium    | negative  | Powell et |
|           |           |           |           | regulatio | al., 2001 |
|           |           |           |           | n\        |           |
|           |           |           |           | of Notch  |           |
|           |           |           |           | signaling |           |
|           |           |           |           | pathway   |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *sens*  | MF        | Strong    | Medium    | R8 cell   | Nolo et   |
|           |           |           |           | different | al., 2000 |
|           |           |           |           | iation    |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *seq*   | MF        | Strong    | No        | R8 cell   | Petrovic  |
|           |           |           |           | developme | and       |
|           |           |           |           | nt        | Hummel,   |
|           |           |           |           |           | 2008      |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *rau*   | MF        | No        | No        | positive  | Sieglitz  |
|           |           |           |           | regulatio | et al.,   |
|           |           |           |           | n\        | 2013      |
|           |           |           |           | of EGFR   |           |
|           |           |           |           | and FGFR  |           |
...
|           | group**   |           |           | n)**      |           |
+===========+===========+===========+===========+===========+===========+
| > *Abl*   | post-MF-p | No        | No        | compound  | Xiong et  |
|           | rox       |           |           | eye       | al., 2009 |
|           |           |           |           | developme |           |
|           |           |           |           | nt        |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *CG1392 | post-MF-p | Weak      | No        | negative  | Khan et   |
| 8*        | rox       |           |           | regulatio | al., 2015 |
|           |           |           |           | n\        |           |
|           |           |           |           | of        |           |
|           |           |           |           | translati |           |
|           |           |           |           | on        |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *CG1772 | post-MF-p | Equal in  | No        |           |           |
| 4*        | rox       | MF        |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *CG3215 | post-MF-p | Equal in  | Weak      | PCP       | Banerjee  |
| 0*        | rox       | MF        |           | signaling | et al.,   |
|           |           |           |           | pathway   | 2017      |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *DAAM*  | post-MF-p | Equal in  | Medium    | regulatio | Matusek   |
|           | rox       | MF        |           | n\        | et al.,   |
|           |           |           |           | of        | 2008      |
|           |           |           |           | axonogene |           |
|           |           |           |           | sis       |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *dila*  | post-MF-p | Not       | No        | cilium    | Ma and    |
|           | rox       | expressed |           | assembly  | Jarman,   |
|           |           |           |           |           | 2011      |
|           |           | in MF     |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *ktub*  | post-MF-p | Not       | No        | deactivat | Chen et   |
|           | rox       | expressed |           | ion       | al., 2012 |
|           |           | \         |           | of        |           |
|           |           | in MF     |           | rhodopsin |           |
|           |           |           |           | mediated  |           |
|           |           |           |           | signaling |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *Lrch*  | post-MF-p | Weak      | Medium    | cytokines | Foussard  |
|           | rox       |           |           | is        | et al.,   |
|           |           |           |           |           | 2010      |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *scrt*  | post-MF-p | Equal in  | Weak      | negative  | Ramat et  |
|           | rox       | MF        |           | regulatio | al., 2016 |
|           |           |           |           | n         |           |
|           |           |           |           | of Notch  |           |
|           |           |           |           | signaling |           |
|           |           |           |           | pathway   |           |
...
|           | group**   |           |           | n)**      |           |
+===========+===========+===========+===========+===========+===========+
| > *CG1509 | post-MF-d | Equal in  | No        | actin     | Goldstein |
| 7*        | ist       | MF        |           | binding   | and       |
|           |           |           |           |           | Gunawarde |
|           |           |           |           |           | na,       |
|           |           |           |           |           | 2000      |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *dpr9*  | post-MF-d | Not       | Medium    | synapse   | Carrillo  |
|           | ist       | expressed |           | organizat | et al.,   |
|           |           | \         |           | ion       | 2015      |
|           |           | in MF     |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *nSyb*  | post-MF-d | Not       | No        | neurotran | Lloyd et  |
|           | ist       | expressed |           | smitter   | al., 2000 |
|           |           |           |           | secretion |           |
|           |           | in MF     |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *Victor | post-MF-d | No data   | No        | response  | Ekengren  |
| ia*       | ist       |           |           | to stress | and       |
|           |           |           |           |           | Hultmark, |
|           |           |           |           |           | 2001      |
+-----------+-----------+-----------+-----------+-----------+-----------+
...
|           | group**   |           |           | n)**      |           |
+===========+===========+===========+===========+===========+===========+
| > *dap\** | pre-post  | No        | No        | cell      | Firth and |
|           |           |           |           | cycle     | Baker,    |
|           |           |           |           | arrest    | 2005      |
+-----------+-----------+-----------+-----------+-----------+-----------+
| > *SRPK*  | pre-post  | Weak      | No        | regulatio | Allemand  |
|           |           |           |           | n         | et al.,   |
|           |           |           |           | of RNA    | 2001      |
|           |           |           |           | splicing  |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
...
**Supplementary Table 3 - A-P boundaries of the identified clusters.**
  ...
  **Cluster**   **Start (A-P)**   **End (A-P)**   **Color**
  ------------- ----------------- --------------- -----------
  Pre-MF                          -2              
  MF-low        -1                3               
  MF-med        -3                2               
